...
var get_hpms_from_sql_2014=function(task,cb){
    ...
    county_with_statement =[
        ...
        "         state_code,fips,route_id, aadt,aadt_single_unit,aadt_combination,",
    ...
    select_statement =[
        ...
        ,"       floor(sum(aadt*sec_len_miles)) as sum_vmt",
        //,"       ,sum(sec_len_miles*through_lanes) as sum_lane_miles",
        ,"       ,sum(aadt_single_unit) as sum_single_unit",
        ,"       ,sum(aadt_single_unit*sec_len_miles) as sum_single_unit_mt",
        ,"       ,sum(aadt_combination) as sum_combination",
        ,"       ,sum(aadt_combination*sec_len_miles) as sum_combination_mt",
        ,"from hpms_joined",
